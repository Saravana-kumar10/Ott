          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  PageTransition(childCurrent: Check(),child: Otl(), type: PageTransitionType.fade,duration: Duration(milliseconds: 900)),
                );
              }, // <-- SEE HERE
                                    ...
                                    children: [
                                      ...
                                      ElevatedButton(onPressed: (){
                                        if(skey.currentState!.validate())
                                        {
                                          ...
                                          Navigator.push(
                                              context,PageTransition(child: Check(), type: PageTransitionType.fade,duration: Duration(seconds: 1))
                                          );
